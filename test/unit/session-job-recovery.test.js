...
function testBackgroundSessionsResumeAndShowBusyStateAfterRestore() {
  ...
  assert.ok(index.includes('bootstrap-workflow.js?v=2.1.2-ime-platform-guard') && index.includes('app.js?v=2.1.42-welcome-compact'), 'runtime entry assets should receive cache-version updates with the recovery fix');
}
