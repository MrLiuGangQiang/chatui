...
function testSessionSwitchRecoveryRebindsWithoutDuplicateExecution() {
  ...
  assert.ok(index.includes('runs.js?v=1.2.66-session-run-owner') && index.includes('submit-workflow.js?v=1.2.80-pending-session-continuity') && index.includes('app.js?v=2.1.26-pending-session-continuity') && index.includes('chatui.bundle.js?v=1.3.113-pending-session-continuity'), 'browser cache versions must deliver the session-run ownership fix');
}
