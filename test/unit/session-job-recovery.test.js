...
function testBackgroundSessionsResumeAndShowBusyStateAfterRestore() {
  ...
  assert.ok(index.includes('bootstrap-workflow.js?v=2.1.1-ime-enter-guard') && index.includes('app.js?v=2.1.39-session-route-model'), 'runtime entry assets should receive cache-version updates with the recovery fix');
}
