...
function testDownloadFilenamesUseShanghaiTimestamp() {
  ...
  assert.ok(index.includes('client/ui/file-actions.js?v=1.2.67') && index.includes('client/app/image-actions-workflow.js?v=1.2.68') && index.includes('client/app/image-result-workflow.js?v=1.2.69') && index.includes('app.js?v=1.3.56-stopfix4') && index.includes('chatui.bundle.js?v=1.3.48-arch83'), 'download filename changes should bump browser cache versions');
  assert.ok(bundleSource.includes("BUNDLE_VERSION = '1.3.48-arch83'"), 'server bundle version should match download filename cache-busting');
}
...
function testChatAnswerStreamingFlushesQuickly() {
  ...
  assert.ok(index.includes('chat-workflow.js?v=1.3.17') && index.includes('chatui.bundle.js?v=1.3.48-arch83') && bundle.includes("BUNDLE_VERSION = '1.3.48-arch83'"), 'cache-busting versions should be bumped for streaming performance fixes');
}
...
function testLegacyWelcomeScreenIsRestored() {
  ...
  assert.ok(index.includes('./app.js?v=1.3.56-stopfix4'), 'app.js cache version should change after stop-stream cleanup updates');
...
function testQuotePreviewIsFeatureModule() {
  ...
  assert.ok(index.includes('message-workflow.js?v=1.3.31-scrollfix') && index.includes('message-model.js?v=1.0.1') && index.includes('message-domain.js?v=1.0.1') && index.includes('styles/messages.css?v=1.3.12') && index.includes('chatui.bundle.js?v=1.3.48-arch83'), 'quote filtering and jump flash changes should bump cache versions');
...
function testHistoryAnchorLastQuestionSpacerClearsOnSubmit() {
  ...
  assert.ok(index.includes('history-anchor-nav.js?v=1.0.18') && index.includes('submit-workflow.js?v=1.3.62') && index.includes('chatui.bundle.js?v=1.3.48-arch83'), 'history spacer submit fix should bump browser cache versions');
  assert.ok(bundleSource.includes("BUNDLE_VERSION = '1.3.48-arch83'"), 'server bundle version should match the directory spacer fix cache-busting');
}
...
function testReasoningCompletesBeforeAnswerStreaming() {
  ...
  const index = fs.readFileSync(path.join(__dirname, '../index.html'), 'utf8');
  assert.ok(index.includes('chat-workflow.js?v=1.3.17') && index.includes('chatui.bundle.js?v=1.3.48-arch83'), 'chat stream reasoning-state fix should bump cache versions');
}
...
function testReasoningUnavailableWhenAnswerStartsWithoutReasoning() {
  ...
  const index = fs.readFileSync(path.join(__dirname, '../index.html'), 'utf8');
  assert.ok(index.includes('chat-workflow.js?v=1.3.17') && index.includes('chatui.bundle.js?v=1.3.48-arch83'), 'empty-reasoning stream fix should bump cache versions');
}
...
function testReasoningMenuCloseReleasesFocusBeforeAriaHidden() {
  ...
  const index = fs.readFileSync(path.join(__dirname, '../index.html'), 'utf8');
  assert.ok(index.includes('reasoning-workflow.js?v=1.3.29-ds3') && index.includes('chatui.bundle.js?v=1.3.48-arch83'), 'reasoning menu accessibility fix should bump cache versions');
}
...
function testConfigBaseUrlDefault() {
  ...
  assert.ok(index.includes('config-workflow.js?v=1.2.69') && index.includes('chatui.bundle.js?v=1.3.48-arch83'), 'config default change should bump cache-busting versions');
  assert.ok(bundleSource.includes("BUNDLE_VERSION = '1.3.48-arch83'"), 'server bundle version should match the index cache-busting version');
}
...
function testForceImageButtonOnUserMessages() {
  ...
  assert.ok(index.includes('message-workflow.js?v=1.3.31-scrollfix') && index.includes('app.js?v=1.3.56-stopfix4') && index.includes('assets/chatui.bundle.css?v=1.3.48-arch68') && index.includes('chatui.bundle.js?v=1.3.48-arch83') && index.includes('styles/flat-theme.css?v=2.1.53'), 'force-image UI and action changes should bump cache-busting versions');
  assert.ok(bundleSource.includes("BUNDLE_VERSION = '1.3.48-arch83'"), 'server bundle version should match the force-image bundle cache-busting version');
}
...
function testImagePreviewWheelZoom() {
  ...
  assert.ok(index.includes('image-preview-workflow.js?v=1.2.66') && index.includes('chatui.bundle.js?v=1.3.48-arch83') && index.includes('styles/flat-theme.css?v=2.1.53'), 'image preview zoom should bump cache-busting versions');
  assert.ok(bundleSource.includes("BUNDLE_VERSION = '1.3.48-arch83'"), 'server bundle version should match image preview zoom bundle cache-busting');
}
...
function testMessageActionButtonsUsePolishedStyle() {
  ...
  assert.ok(index.includes('assets/chatui.bundle.css?v=1.3.48-arch68') && index.includes('chatui.bundle.js?v=1.3.48-arch83') && index.includes('styles/flat-theme.css?v=2.1.53'), 'message action visual polish should bump cache-busting versions');
  assert.ok(bundleSource.includes("BUNDLE_VERSION = '1.3.48-arch83'"), 'server bundle version should match message action polish cache-busting');
}
...
function testPendingFeedbackDoesNotWrapOnMobile() {
  ...
  assert.ok(index.includes('assets/chatui.bundle.css?v=1.3.48-arch68') && index.includes('chatui.bundle.js?v=1.3.48-arch83') && index.includes('styles/flat-theme.css?v=2.1.53'), 'pending feedback mobile nowrap fix should bump cache-busting versions');
  assert.ok(bundleSource.includes("BUNDLE_VERSION = '1.3.48-arch83'"), 'server bundle version should match pending feedback cache-busting');
}
...
function testRouteTimeoutShowsSlowNoticeThenManualChoice() {
  ...
  assert.ok(index.includes('submit-workflow.js?v=1.3.62') && index.includes('chat-workflow.js?v=1.3.17') && index.includes('route-decision-workflow.js?v=1.3.18') && index.includes('app.js?v=1.3.56-stopfix4') && index.includes('flat-theme.css?v=2.1.53'), 'cache versions should be bumped for route timeout UX');
}
