...
function testRouteTimeoutShowsSlowNoticeThenFailsCleanly() {
  ...
  assert.ok(index.includes('intent-contract.js?v=2.0.6-message-reference-generation') && index.includes('submit-workflow.js?v=1.2.97-explicit-quote-binding') && index.includes('chat-workflow.js?v=1.3.25-interface-completion') && index.includes('route-decision-workflow.js?v=2.0.6-single-route-repair') && index.includes('route-service.js?v=2.1.10-message-reference-generation') && index.includes('app.js?v=2.1.53-session-attachment-isolation') && index.includes('flat-theme.css?v=2.2.3-code-action-motion'), 'cache versions should be bumped for route timeout UX');
}
