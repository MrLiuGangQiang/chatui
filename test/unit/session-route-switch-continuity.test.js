...
function testSessionSwitchRecoveryRebindsWithoutDuplicateExecution() {
  ...
  assert.ok(index.includes('runs.js?v=1.2.66-session-run-owner') && index.includes('submit-workflow.js?v=1.2.88-session-route-model') && index.includes('app.js?v=2.1.39-session-route-model') && index.includes('chatui.bundle.js?v=1.3.129-ime-enter-guard'), 'browser cache versions must deliver the session-run ownership fix');
}
