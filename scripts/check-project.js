...
function checkProject({ root = ROOT } = {}) {
  ...
  for (const script of ['check:project', 'check:architecture', 'check:syntax', 'check', 'test', 'eval:intent', 'start', 'verify:release', 'verify:release-ref', 'verify:image', 'identity', 'preview:release']) {
