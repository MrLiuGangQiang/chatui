...
function testDownloadFilenamesUseShanghaiTimestamp() {
  ...
  assert.ok(index.includes('client/ui/file-actions.js?v=1.2.67') && index.includes('client/app/image-actions-workflow.js?v=1.2.68') && index.includes('client/app/image-result-workflow.js?v=1.7.1-image-semantics') && index.includes('app.js?v=2.1.48-route-model-switch-guard') && index.includes('chatui.bundle.js?v=1.3.147-interface-completion'), 'browser cache versions should match the current static bundle');
  assert.ok(bundleSource.includes("BUNDLE_VERSION = '1.3.147-interface-completion'"), 'server bundle version should match browser cache-busting');
}
...
function testChatAnswerStreamingFlushesQuickly() {
  ...
  assert.ok(index.includes('chat-workflow.js?v=1.3.25-interface-completion') && index.includes('chatui.bundle.js?v=1.3.147-interface-completion') && bundle.includes("BUNDLE_VERSION = '1.3.147-interface-completion'"), 'cache-busting versions should be bumped for streaming performance fixes');
}
...
function testHistoryAnchorLastQuestionSpacerClearsOnSubmit() {
  ...
  assert.ok(index.includes('history-anchor-nav.js?v=1.0.18') && index.includes('submit-workflow.js?v=1.2.90-interface-completion') && index.includes('chatui.bundle.js?v=1.3.147-interface-completion'), 'history spacer submit fix should bump browser cache versions');
  assert.ok(bundleSource.includes("BUNDLE_VERSION = '1.3.147-interface-completion'"), 'server bundle version should match the directory spacer fix cache-busting');
}
...
function testRegenerateSavesEarlyPendingSubmitBeforeRoute() {
  ...
  const index = fs.readFileSync(path.join(__dirname, '../../index.html'), 'utf8');
  assert.ok(index.includes('regenerate-workflow.js?v=1.0.3-interface-completion') && index.includes('app.js?v=2.1.48-route-model-switch-guard') && index.includes('chatui.bundle.js?v=1.3.147-interface-completion'), 'cache versions should deliver the canonical regenerate workflow');
}
...
function testReasoningCompletesBeforeAnswerStreaming() {
  ...
  const index = fs.readFileSync(path.join(__dirname, '../../index.html'), 'utf8');
  assert.ok(index.includes('chat-workflow.js?v=1.3.25-interface-completion') && index.includes('chatui.bundle.js?v=1.3.147-interface-completion'), 'chat stream reasoning-state fix should bump cache versions');
}
...
function testReasoningUnavailableWhenAnswerStartsWithoutReasoning() {
  ...
  const index = fs.readFileSync(path.join(__dirname, '../../index.html'), 'utf8');
  assert.ok(index.includes('chat-workflow.js?v=1.3.25-interface-completion') && index.includes('chatui.bundle.js?v=1.3.147-interface-completion'), 'empty-reasoning stream fix should bump cache versions');
}
...
function testReasoningMenuCloseReleasesFocusBeforeAriaHidden() {
  ...
  assert.ok(index.includes('reasoning-workflow.js?v=1.3.35-reasoning-persistence') && index.includes('composer.css?v=1.3.2-gpt5-reasoning-menu') && index.includes('chatui.bundle.js?v=1.3.147-interface-completion'), 'reasoning menu changes should bump cache versions');
}
...
function testCodeActionHoverAndHistoryAnchorActivePolish() {
  ...
  const index = fs.readFileSync(path.join(__dirname, '../../index.html'), 'utf8');
  assert.ok(index.includes('styles/flat-theme.css?v=2.1.95-welcome-globe-only') && index.includes('assets/chatui.bundle.css?v=1.3.147-interface-completion'), 'CSS bundle cache versions should be bumped for visual fixes');
}
...
function testConfigCopyButtonsForBaseUrlAndApiKey() {
  ...
  assert.ok(index.includes('config-workflow.js?v=1.2.76-busy-route-model-guard') && index.includes('bootstrap-workflow.js?v=2.1.2-ime-platform-guard') && index.includes('styles/flat-theme.css?v=2.1.95-welcome-globe-only') && index.includes('app.js?v=2.1.48-route-model-switch-guard') && index.includes('chatui.bundle.js?v=1.3.147-interface-completion'), 'config copy UI changes should bump browser cache versions');
  assert.ok(bundleSource.includes("BUNDLE_VERSION = '1.3.147-interface-completion'"), 'server bundle version should match config copy cache-busting');
}
...
function testForceImageButtonOnUserMessages() {
  ...
  assert.ok(index.includes('message-workflow.js?v=1.3.39-image-quote') && index.includes('regenerate-workflow.js?v=1.0.3-interface-completion') && index.includes('app.js?v=2.1.48-route-model-switch-guard') && index.includes('assets/chatui.bundle.css?v=1.3.147-interface-completion') && index.includes('chatui.bundle.js?v=1.3.147-interface-completion') && index.includes('styles/flat-theme.css?v=2.1.95-welcome-globe-only'), 'force-image UI and action changes should bump cache-busting versions');
  assert.ok(bundleSource.includes("BUNDLE_VERSION = '1.3.147-interface-completion'"), 'server bundle version should match force-image cache-busting');
}
...
function testImagePreviewWheelZoom() {
  ...
  assert.ok(index.includes('image-preview-workflow.js?v=1.2.67') && index.includes('chatui.bundle.js?v=1.3.147-interface-completion') && index.includes('styles/flat-theme.css?v=2.1.95-welcome-globe-only'), 'image preview zoom should bump cache-busting versions');
  assert.ok(bundleSource.includes("BUNDLE_VERSION = '1.3.147-interface-completion'"), 'server bundle version should match image preview zoom bundle cache-busting');
}
...
function testMessageActionButtonsUsePolishedStyle() {
  ...
  assert.ok(index.includes('assets/chatui.bundle.css?v=1.3.147-interface-completion') && index.includes('chatui.bundle.js?v=1.3.147-interface-completion') && index.includes('styles/flat-theme.css?v=2.1.95-welcome-globe-only'), 'message action visual polish should bump cache-busting versions');
  assert.ok(bundleSource.includes("BUNDLE_VERSION = '1.3.147-interface-completion'"), 'server bundle version should match message action polish cache-busting');
}
...
function testPendingFeedbackDoesNotWrapOnMobile() {
  ...
  assert.ok(index.includes('assets/chatui.bundle.css?v=1.3.147-interface-completion') && index.includes('chatui.bundle.js?v=1.3.147-interface-completion') && index.includes('styles/flat-theme.css?v=2.1.95-welcome-globe-only'), 'pending feedback mobile nowrap fix should bump cache-busting versions');
  assert.ok(bundleSource.includes("BUNDLE_VERSION = '1.3.147-interface-completion'"), 'server bundle version should match pending feedback cache-busting');
}
...
function testComposerWidthFollowsSidebarCollapsedMessageColumn() {
  ...
  assert.ok(index.includes('assets/chatui.bundle.css?v=1.3.147-interface-completion') && index.includes('chatui.bundle.js?v=1.3.147-interface-completion') && index.includes('styles/flat-theme.css?v=2.1.95-welcome-globe-only'), 'sidebar composer width fix should bump browser cache versions');
  assert.ok(bundleSource.includes("BUNDLE_VERSION = '1.3.147-interface-completion'"), 'server bundle version should match sidebar composer cache-busting');
}
...
function testRouteTimeoutShowsSlowNoticeThenFailsCleanly() {
  ...
  assert.ok(app.includes('clearReasoning,setImageContext') && index.includes('image-workflow.js?v=1.3.21-interface-completion'), 'image reasoning cleanup should be wired and cache-busted');
...
function testImageSuccessResultReconciliation() {
  ...
  assert.ok(index.includes('image-workflow.js?v=1.3.21-interface-completion') && index.includes('job-resume-workflow.js?v=1.2.77-owner-finally') && index.includes('app.js?v=2.1.48-route-model-switch-guard'), 'image success reconciliation should bump workflow and app cache versions');
}
