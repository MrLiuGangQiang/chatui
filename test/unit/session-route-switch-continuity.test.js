...
function testSessionSwitchRecoveryRebindsWithoutDuplicateExecution() {
  ...
  assert.ok(index.includes('runs.js?v=1.2.66-session-run-owner') && index.includes('submit-workflow.js?v=1.2.87-message-size-guard') && index.includes('app.js?v=2.1.37-preinsert-guard') && index.includes('chatui.bundle.js?v=1.3.121-task-null-settle'), 'browser cache versions must deliver the session-run ownership fix');
}
