...
function testSessionSwitchRecoveryRebindsWithoutDuplicateExecution() {
  ...
  assert.ok(index.includes('runs.js?v=1.2.66-session-run-owner') && index.includes('submit-workflow.js?v=1.2.86-message-projection') && index.includes('app.js?v=2.1.35-background-settle') && index.includes('chatui.bundle.js?v=1.3.120-background-settle'), 'browser cache versions must deliver the session-run ownership fix');
}
