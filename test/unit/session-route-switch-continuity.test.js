...
function testSessionSwitchRecoveryRebindsWithoutDuplicateExecution() {
  ...
  assert.ok(index.includes('runs.js?v=1.2.66-session-run-owner') && index.includes('submit-workflow.js?v=1.2.77-session-run-owner') && index.includes('app.js?v=2.1.22-session-run-owner') && index.includes('chatui.bundle.js?v=1.3.109-session-run-owner'), 'browser cache versions must deliver the session-run ownership fix');
}
