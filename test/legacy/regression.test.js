...
function testDownloadFilenamesUseShanghaiTimestamp() {
  ...
  assert.ok(index.includes('client/ui/file-actions.js?v=1.2.67') && index.includes('client/app/image-actions-workflow.js?v=1.2.68') && index.includes('client/app/image-result-workflow.js?v=1.7.1-image-semantics') && index.includes('app.js?v=2.1.46-authine-workspace') && index.includes('chatui.bundle.js?v=1.3.140-model-switch-route-retry'), 'browser cache versions should match the current static bundle');
  assert.ok(bundleSource.includes("BUNDLE_VERSION = '1.3.140-model-switch-route-retry'"), 'server bundle version should match browser cache-busting');
}
...
function testPendingClarificationClearsAfterMergedSend() {
  ...
  const index = fs.readFileSync(path.join(__dirname, '../../index.html'), 'utf8');
  assert.ok(index.includes('submit-workflow.js?v=1.2.88-session-route-model'), 'submit workflow cache version should be bumped for pending clarification fix');
...
function testChatAnswerStreamingFlushesQuickly() {
  ...
  assert.ok(index.includes('chat-workflow.js?v=1.3.24-task-lifecycle-state-machine') && index.includes('chatui.bundle.js?v=1.3.140-model-switch-route-retry') && bundle.includes("BUNDLE_VERSION = '1.3.140-model-switch-route-retry'"), 'cache-busting versions should be bumped for streaming performance fixes');
}
...
function testEmptySessionRendersPremiumWelcome() {
  ...
  assert.ok(index.includes('./app.js?v=2.1.46-authine-workspace') && index.includes('flat-theme.css?v=2.1.95-welcome-globe-only'), 'welcome assets should use updated cache versions');
...
function testHistoryAnchorLastQuestionSpacerClearsOnSubmit() {
  ...
  assert.ok(index.includes('history-anchor-nav.js?v=1.0.18') && index.includes('submit-workflow.js?v=1.2.88-session-route-model') && index.includes('chatui.bundle.js?v=1.3.140-model-switch-route-retry'), 'history spacer submit fix should bump browser cache versions');
  assert.ok(bundleSource.includes("BUNDLE_VERSION = '1.3.140-model-switch-route-retry'"), 'server bundle version should match the directory spacer fix cache-busting');
}
...
function testRegenerateSavesEarlyPendingSubmitBeforeRoute() {
  ...
  const index = fs.readFileSync(path.join(__dirname, '../../index.html'), 'utf8');
  assert.ok(index.includes('regenerate-workflow.js?v=1.0.2-canonical-route-plan') && index.includes('app.js?v=2.1.46-authine-workspace') && index.includes('chatui.bundle.js?v=1.3.140-model-switch-route-retry'), 'cache versions should deliver the canonical regenerate workflow');
}
...
function testReasoningCompletesBeforeAnswerStreaming() {
  ...
  const index = fs.readFileSync(path.join(__dirname, '../../index.html'), 'utf8');
  assert.ok(index.includes('chat-workflow.js?v=1.3.24-task-lifecycle-state-machine') && index.includes('chatui.bundle.js?v=1.3.140-model-switch-route-retry'), 'chat stream reasoning-state fix should bump cache versions');
}
...
function testReasoningUnavailableWhenAnswerStartsWithoutReasoning() {
  ...
  const index = fs.readFileSync(path.join(__dirname, '../../index.html'), 'utf8');
  assert.ok(index.includes('chat-workflow.js?v=1.3.24-task-lifecycle-state-machine') && index.includes('chatui.bundle.js?v=1.3.140-model-switch-route-retry'), 'empty-reasoning stream fix should bump cache versions');
}
...
function testReasoningMenuCloseReleasesFocusBeforeAriaHidden() {
  ...
  assert.ok(index.includes('reasoning-workflow.js?v=1.3.35-reasoning-persistence') && index.includes('composer.css?v=1.3.2-gpt5-reasoning-menu') && index.includes('chatui.bundle.js?v=1.3.140-model-switch-route-retry'), 'reasoning menu changes should bump cache versions');
}
...
function testCodeActionHoverAndHistoryAnchorActivePolish() {
  ...
  const index = fs.readFileSync(path.join(__dirname, '../../index.html'), 'utf8');
  assert.ok(index.includes('styles/flat-theme.css?v=2.1.95-welcome-globe-only') && index.includes('assets/chatui.bundle.css?v=1.3.140-model-switch-route-retry'), 'CSS bundle cache versions should be bumped for visual fixes');
}
...
function testConfigBaseUrlDefault() {
  ...
  assert.ok(index.includes('config-workflow.js?v=1.2.75-visible-model-selection'), 'config workflow changes should bump browser cache-busting version');
...
function testConfigCopyButtonsForBaseUrlAndApiKey() {
  ...
  assert.ok(index.includes('config-workflow.js?v=1.2.75-visible-model-selection') && index.includes('bootstrap-workflow.js?v=2.1.2-ime-platform-guard') && index.includes('styles/flat-theme.css?v=2.1.95-welcome-globe-only') && index.includes('app.js?v=2.1.46-authine-workspace') && index.includes('chatui.bundle.js?v=1.3.140-model-switch-route-retry'), 'config copy UI changes should bump browser cache versions');
  assert.ok(bundleSource.includes("BUNDLE_VERSION = '1.3.140-model-switch-route-retry'"), 'server bundle version should match config copy cache-busting');
}
...
function testForceImageButtonOnUserMessages() {
  ...
  assert.ok(index.includes('message-workflow.js?v=1.3.39-image-quote') && index.includes('regenerate-workflow.js?v=1.0.2-canonical-route-plan') && index.includes('app.js?v=2.1.46-authine-workspace') && index.includes('assets/chatui.bundle.css?v=1.3.140-model-switch-route-retry') && index.includes('chatui.bundle.js?v=1.3.140-model-switch-route-retry') && index.includes('styles/flat-theme.css?v=2.1.95-welcome-globe-only'), 'force-image UI and action changes should bump cache-busting versions');
  assert.ok(bundleSource.includes("BUNDLE_VERSION = '1.3.140-model-switch-route-retry'"), 'server bundle version should match force-image cache-busting');
}
...
function testImagePreviewWheelZoom() {
  ...
  assert.ok(index.includes('image-preview-workflow.js?v=1.2.67') && index.includes('chatui.bundle.js?v=1.3.140-model-switch-route-retry') && index.includes('styles/flat-theme.css?v=2.1.95-welcome-globe-only'), 'image preview zoom should bump cache-busting versions');
  assert.ok(bundleSource.includes("BUNDLE_VERSION = '1.3.140-model-switch-route-retry'"), 'server bundle version should match image preview zoom bundle cache-busting');
}
...
function testMessageActionButtonsUsePolishedStyle() {
  ...
  assert.ok(index.includes('assets/chatui.bundle.css?v=1.3.140-model-switch-route-retry') && index.includes('chatui.bundle.js?v=1.3.140-model-switch-route-retry') && index.includes('styles/flat-theme.css?v=2.1.95-welcome-globe-only'), 'message action visual polish should bump cache-busting versions');
  assert.ok(bundleSource.includes("BUNDLE_VERSION = '1.3.140-model-switch-route-retry'"), 'server bundle version should match message action polish cache-busting');
}
...
function testPendingFeedbackDoesNotWrapOnMobile() {
  ...
  assert.ok(index.includes('assets/chatui.bundle.css?v=1.3.140-model-switch-route-retry') && index.includes('chatui.bundle.js?v=1.3.140-model-switch-route-retry') && index.includes('styles/flat-theme.css?v=2.1.95-welcome-globe-only'), 'pending feedback mobile nowrap fix should bump cache-busting versions');
  assert.ok(bundleSource.includes("BUNDLE_VERSION = '1.3.140-model-switch-route-retry'"), 'server bundle version should match pending feedback cache-busting');
}
...
function testComposerWidthFollowsSidebarCollapsedMessageColumn() {
  ...
  assert.ok(index.includes('assets/chatui.bundle.css?v=1.3.140-model-switch-route-retry') && index.includes('chatui.bundle.js?v=1.3.140-model-switch-route-retry') && index.includes('styles/flat-theme.css?v=2.1.95-welcome-globe-only'), 'sidebar composer width fix should bump browser cache versions');
  assert.ok(bundleSource.includes("BUNDLE_VERSION = '1.3.140-model-switch-route-retry'"), 'server bundle version should match sidebar composer cache-busting');
}
...
function testRouteTimeoutShowsSlowNoticeThenFailsCleanly() {
  ...
  assert.ok(index.includes('submit-workflow.js?v=1.2.88-session-route-model') && index.includes('chat-workflow.js?v=1.3.24-task-lifecycle-state-machine') && index.includes('route-decision-workflow.js?v=2.0.2-model-switch-retry') && index.includes('app.js?v=2.1.46-authine-workspace') && index.includes('flat-theme.css?v=2.1.95-welcome-globe-only'), 'cache versions should be bumped for route timeout UX');
}
...
function testImageSuccessResultReconciliation() {
  ...
  assert.ok(index.includes('image-result-reconciliation.js?v=1.0.0') && index.indexOf('image-result-reconciliation.js?v=1.0.0') < index.indexOf('app.js?v=2.1.46-authine-workspace'), 'reconciliation module should load before app.js');
  assert.ok(index.includes('image-workflow.js?v=1.3.20-edit-resend-tdz') && index.includes('job-resume-workflow.js?v=1.2.76-background-settle') && index.includes('app.js?v=2.1.46-authine-workspace'), 'image success reconciliation should bump workflow and app cache versions');
}
