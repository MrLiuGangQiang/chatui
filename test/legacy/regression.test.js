...
function testDownloadFilenamesUseShanghaiTimestamp() {
  ...
  assert.ok(index.includes('client/ui/file-actions.js?v=1.2.67') && index.includes('client/app/image-actions-workflow.js?v=1.2.68') && index.includes('client/app/image-result-workflow.js?v=1.2.70-durable-image-result') && index.includes('app.js?v=2.1.8-job-recovery') && index.includes('chatui.bundle.js?v=1.3.101-web-preview-iframe-borderless'), 'browser cache versions should match the current static bundle');
...
function testRegenerateSavesEarlyPendingSubmitBeforeRoute() {
  ...
  const index = fs.readFileSync(path.join(__dirname, '../../index.html'), 'utf8');
  assert.ok(index.includes('submit-workflow.js?v=1.2.75-route-request-args') && index.includes('app.js?v=2.1.8-job-recovery') && index.includes('chatui.bundle.js?v=1.3.101-web-preview-iframe-borderless'), 'cache versions should be bumped for regenerate early-refresh recovery');
}
...
function testReasoningMenuCloseReleasesFocusBeforeAriaHidden() {
  ...
  assert.ok(index.includes('reasoning-workflow.js?v=1.3.34-reasoning-history') && index.includes('composer.css?v=1.3.2-gpt5-reasoning-menu') && index.includes('chatui.bundle.js?v=1.3.101-web-preview-iframe-borderless'), 'reasoning menu changes should bump cache versions');
}
...
function testConfigCopyButtonsForBaseUrlAndApiKey() {
  ...
  assert.ok(index.includes('config-workflow.js?v=1.2.73-configurable-upstream') && index.includes('bootstrap-workflow.js?v=2.0.2-gpt5-reasoning') && index.includes('styles/flat-theme.css?v=2.1.71') && index.includes('app.js?v=2.1.8-job-recovery') && index.includes('chatui.bundle.js?v=1.3.101-web-preview-iframe-borderless'), 'config copy UI changes should bump browser cache versions');
...
function testForceImageButtonOnUserMessages() {
  ...
  assert.ok(index.includes('message-workflow.js?v=1.3.34-web-preview-first-open') && index.includes('app.js?v=2.1.8-job-recovery') && index.includes('assets/chatui.bundle.css?v=1.3.101-web-preview-iframe-borderless') && index.includes('chatui.bundle.js?v=1.3.101-web-preview-iframe-borderless') && index.includes('styles/flat-theme.css?v=2.1.71'), 'force-image UI and action changes should bump cache-busting versions');
