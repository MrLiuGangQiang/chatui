...
Progress as of July 18, 2026: the pure reducer, browser namespace registration, shared event dispatcher, normal submit-path projection, explicit stop workflow, and standalone regenerate paths are complete. Recovery and background-follow workflows remain to be migrated in separate pull requests.
