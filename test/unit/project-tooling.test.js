...
function createProjectFixture() {
  ...
  writeFixtureFile(root, 'Dockerfile', 'COPY server.js ./server.js\n');
  writeFixtureFile(root, 'server/http/static.js', "const PUBLIC_PREFIXES = ['/client/'];\n");
...
function testProjectToolingChecksStaticAndPackageContracts() {
  ...
  assert.strictEqual(result.staticFiles, 4);
