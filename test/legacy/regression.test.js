...
const sessionLegacyMigrationTests = require('../unit/session-legacy-migration.test');
...
function testDownloadFilenamesUseShanghaiTimestamp() {
  ...
  assert.ok(index.includes('client/ui/file-actions.js?v=1.2.67') && index.includes('client/app/image-actions-workflow.js?v=1.2.68') && index.includes('client/app/image-result-workflow.js?v=1.2.70-durable-image-result') && index.includes('app.js?v=2.1.8-job-recovery') && index.includes('chatui.bundle.js?v=1.3.104-snapshot-history-recovery'), 'browser cache versions should match the current static bundle');
  assert.ok(bundleSource.includes("BUNDLE_VERSION = '1.3.104-snapshot-history-recovery'"), 'server bundle version should match browser cache-busting');
}
...
function testChatAnswerStreamingFlushesQuickly() {
  ...
  assert.ok(index.includes('chat-workflow.js?v=1.3.21-single-request-fallback') && index.includes('chatui.bundle.js?v=1.3.104-snapshot-history-recovery') && bundle.includes("BUNDLE_VERSION = '1.3.104-snapshot-history-recovery'"), 'cache-busting versions should be bumped for streaming performance fixes');
}
...
function testQuotePreviewIsFeatureModule() {
  ...
  assert.ok(index.includes('message-workflow.js?v=1.3.34-web-preview-first-open') && index.includes('message-model.js?v=1.0.1') && index.includes('message-domain.js?v=1.0.1') && index.includes('styles/messages.css?v=1.3.17-web-preview-iframe-borderless') && index.includes('chatui.bundle.js?v=1.3.104-snapshot-history-recovery'), 'quote filtering and jump flash changes should bump cache versions');
...
function testHistoryAnchorLastQuestionSpacerClearsOnSubmit() {
  ...
  assert.ok(index.includes('history-anchor-nav.js?v=1.0.18') && index.includes('submit-workflow.js?v=1.2.75-route-request-args') && index.includes('chatui.bundle.js?v=1.3.104-snapshot-history-recovery'), 'history spacer submit fix should bump browser cache versions');
  assert.ok(bundleSource.includes("BUNDLE_VERSION = '1.3.104-snapshot-history-recovery'"), 'server bundle version should match the directory spacer fix cache-busting');
}
...
function testRegenerateSavesEarlyPendingSubmitBeforeRoute() {
  ...
  const index = fs.readFileSync(path.join(__dirname, '../../index.html'), 'utf8');
  assert.ok(index.includes('submit-workflow.js?v=1.2.75-route-request-args') && index.includes('app.js?v=2.1.8-job-recovery') && index.includes('chatui.bundle.js?v=1.3.104-snapshot-history-recovery'), 'cache versions should be bumped for regenerate early-refresh recovery');
}
...
function testReasoningCompletesBeforeAnswerStreaming() {
  ...
  const index = fs.readFileSync(path.join(__dirname, '../../index.html'), 'utf8');
  assert.ok(index.includes('chat-workflow.js?v=1.3.21-single-request-fallback') && index.includes('chatui.bundle.js?v=1.3.104-snapshot-history-recovery'), 'chat stream reasoning-state fix should bump cache versions');
}
...
function testReasoningUnavailableWhenAnswerStartsWithoutReasoning() {
  ...
  const index = fs.readFileSync(path.join(__dirname, '../../index.html'), 'utf8');
  assert.ok(index.includes('chat-workflow.js?v=1.3.21-single-request-fallback') && index.includes('chatui.bundle.js?v=1.3.104-snapshot-history-recovery'), 'empty-reasoning stream fix should bump cache versions');
}
...
function testReasoningMenuCloseReleasesFocusBeforeAriaHidden() {
  ...
  assert.ok(index.includes('reasoning-workflow.js?v=1.3.34-reasoning-history') && index.includes('composer.css?v=1.3.2-gpt5-reasoning-menu') && index.includes('chatui.bundle.js?v=1.3.104-snapshot-history-recovery'), 'reasoning menu changes should bump cache versions');
}
...
function testCodeActionHoverAndHistoryAnchorActivePolish() {
  ...
  const index = fs.readFileSync(path.join(__dirname, '../../index.html'), 'utf8');
  assert.ok(index.includes('styles/flat-theme.css?v=2.1.71') && index.includes('assets/chatui.bundle.css?v=1.3.104-snapshot-history-recovery'), 'CSS bundle cache versions should be bumped for visual fixes');
}
...
function testConfigCopyButtonsForBaseUrlAndApiKey() {
  ...
  assert.ok(index.includes('config-workflow.js?v=1.2.73-configurable-upstream') && index.includes('bootstrap-workflow.js?v=2.0.2-gpt5-reasoning') && index.includes('styles/flat-theme.css?v=2.1.71') && index.includes('app.js?v=2.1.8-job-recovery') && index.includes('chatui.bundle.js?v=1.3.104-snapshot-history-recovery'), 'config copy UI changes should bump browser cache versions');
  assert.ok(bundleSource.includes("BUNDLE_VERSION = '1.3.104-snapshot-history-recovery'"), 'server bundle version should match config copy cache-busting');
}
...
function testForceImageButtonOnUserMessages() {
  ...
  assert.ok(index.includes('message-workflow.js?v=1.3.34-web-preview-first-open') && index.includes('app.js?v=2.1.8-job-recovery') && index.includes('assets/chatui.bundle.css?v=1.3.104-snapshot-history-recovery') && index.includes('chatui.bundle.js?v=1.3.104-snapshot-history-recovery') && index.includes('styles/flat-theme.css?v=2.1.71'), 'force-image UI and action changes should bump cache-busting versions');
  assert.ok(bundleSource.includes("BUNDLE_VERSION = '1.3.104-snapshot-history-recovery'"), 'server bundle version should match the force-image bundle cache-busting version');
}
...
function testImagePreviewWheelZoom() {
  ...
  assert.ok(index.includes('image-preview-workflow.js?v=1.2.67') && index.includes('chatui.bundle.js?v=1.3.104-snapshot-history-recovery') && index.includes('styles/flat-theme.css?v=2.1.71'), 'image preview zoom should bump cache-busting versions');
  assert.ok(bundleSource.includes("BUNDLE_VERSION = '1.3.104-snapshot-history-recovery'"), 'server bundle version should match image preview zoom bundle cache-busting');
}
...
function testMessageActionButtonsUsePolishedStyle() {
  ...
  assert.ok(index.includes('assets/chatui.bundle.css?v=1.3.104-snapshot-history-recovery') && index.includes('chatui.bundle.js?v=1.3.104-snapshot-history-recovery') && index.includes('styles/flat-theme.css?v=2.1.71'), 'message action visual polish should bump cache-busting versions');
  assert.ok(bundleSource.includes("BUNDLE_VERSION = '1.3.104-snapshot-history-recovery'"), 'server bundle version should match message action polish cache-busting');
}
...
function testPendingFeedbackDoesNotWrapOnMobile() {
  ...
  assert.ok(index.includes('assets/chatui.bundle.css?v=1.3.104-snapshot-history-recovery') && index.includes('chatui.bundle.js?v=1.3.104-snapshot-history-recovery') && index.includes('styles/flat-theme.css?v=2.1.71'), 'pending feedback mobile nowrap fix should bump cache-busting versions');
  assert.ok(bundleSource.includes("BUNDLE_VERSION = '1.3.104-snapshot-history-recovery'"), 'server bundle version should match pending feedback cache-busting');
}
...
function testComposerWidthFollowsSidebarCollapsedMessageColumn() {
  ...
  assert.ok(index.includes('assets/chatui.bundle.css?v=1.3.104-snapshot-history-recovery') && index.includes('chatui.bundle.js?v=1.3.104-snapshot-history-recovery') && index.includes('styles/flat-theme.css?v=2.1.71'), 'sidebar composer width fix should bump browser cache versions');
  assert.ok(bundleSource.includes("BUNDLE_VERSION = '1.3.104-snapshot-history-recovery'"), 'server bundle version should match sidebar composer cache-busting');
}
