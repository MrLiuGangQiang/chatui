...
function testSessionSwitchRecoveryRebindsWithoutDuplicateExecution() {
  ...
  assert.ok(index.includes('runs.js?v=1.2.66-session-run-owner') && index.includes('submit-workflow.js?v=1.2.87-message-size-guard') && index.includes('app.js?v=2.1.38-multi-image-lifecycle') && index.includes('chatui.bundle.js?v=1.3.125-image-composition-passthrough'), 'browser cache versions must deliver the session-run ownership fix');
}
