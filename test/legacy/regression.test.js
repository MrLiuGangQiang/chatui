...
function testDownloadFilenamesUseShanghaiTimestamp() {
  ...
  assert.ok(index.includes('client/ui/file-actions.js?v=1.2.67') && index.includes('client/app/image-actions-workflow.js?v=1.2.68') && index.includes('client/app/image-result-workflow.js?v=1.2.70-durable-image-result') && index.includes('app.js?v=2.1.25-task-lifecycle-state-machine') && index.includes('chatui.bundle.js?v=1.3.112-task-lifecycle-state-machine'), 'browser cache versions should match the current static bundle');
  assert.ok(bundleSource.includes("BUNDLE_VERSION = '1.3.112-task-lifecycle-state-machine'"), 'server bundle version should match browser cache-busting');
}
...
function testPendingClarificationClearsAfterMergedSend() {
  ...
  const index = fs.readFileSync(path.join(__dirname, '../../index.html'), 'utf8');
  assert.ok(index.includes('submit-workflow.js?v=1.2.79-task-lifecycle-state-machine'), 'submit workflow cache version should be bumped for pending clarification fix');
...
function testChatAnswerStreamingFlushesQuickly() {
  ...
  assert.ok(index.includes('chat-workflow.js?v=1.3.24-task-lifecycle-state-machine') && index.includes('chatui.bundle.js?v=1.3.112-task-lifecycle-state-machine') && bundle.includes("BUNDLE_VERSION = '1.3.112-task-lifecycle-state-machine'"), 'cache-busting versions should be bumped for streaming performance fixes');
}
...
function testStreamingTailRendersWithoutCursor() {
  ...
  assert.ok(index.includes('browser-streaming-renderer.js?v=1.2.91') && index.includes('message-workflow.js?v=1.3.36-task-lifecycle-state-machine') && index.includes('flat-theme.css?v=2.1.87-route-fit'), 'cache-busting versions should be bumped after removing the streaming cursor');
}
...
function testEmptySessionEmbedsRouteDiagram() {
  ...
  assert.ok(index.includes('./app.js?v=2.1.25-task-lifecycle-state-machine') && index.includes('flat-theme.css?v=2.1.87-route-fit'), 'embedded diagram assets should use updated cache versions');
...
function testQuotePreviewIsFeatureModule() {
  ...
  assert.ok(index.includes('message-workflow.js?v=1.3.36-task-lifecycle-state-machine') && index.includes('message-model.js?v=1.0.1') && index.includes('message-domain.js?v=1.0.1') && index.includes('styles/messages.css?v=1.3.17-web-preview-iframe-borderless') && index.includes('chatui.bundle.js?v=1.3.112-task-lifecycle-state-machine'), 'quote filtering and jump flash changes should bump cache versions');
...
function testMarkdownLiveStreamIsFeatureModule() {
  ...
  assert.ok(index.includes('browser-streaming-renderer.js?v=1.2.91') && index.includes('markdown-live-stream.js?v=1.0.3') && index.includes('message-workflow.js?v=1.3.36-task-lifecycle-state-machine'), 'streaming table/smoothness fixes should bump browser cache versions');
}
...
function testHistoryAnchorLastQuestionSpacerClearsOnSubmit() {
  ...
  assert.ok(index.includes('history-anchor-nav.js?v=1.0.18') && index.includes('submit-workflow.js?v=1.2.79-task-lifecycle-state-machine') && index.includes('chatui.bundle.js?v=1.3.112-task-lifecycle-state-machine'), 'history spacer submit fix should bump browser cache versions');
  assert.ok(bundleSource.includes("BUNDLE_VERSION = '1.3.112-task-lifecycle-state-machine'"), 'server bundle version should match the directory spacer fix cache-busting');
}
...
function testResumeStreamingDoesNotUseStatusTextAsOffset() {
  ...
  assert.ok(app.includes('state.pageUnloading=!1;if(window.ChatUIApp?.runs?.isLiveRun?.(getActiveRun(e)))') && app.includes('imageJob=loadImageJob(e),chatJob=loadLatestChatJob(e),handoffOwner='), 'resume should clear stale page-unloading state and preserve the live in-memory owner before durable recovery');
...
function testRegenerateSavesEarlyPendingSubmitBeforeRoute() {
  ...
  const index = fs.readFileSync(path.join(__dirname, '../../index.html'), 'utf8');
  assert.ok(index.includes('submit-workflow.js?v=1.2.79-task-lifecycle-state-machine') && index.includes('app.js?v=2.1.25-task-lifecycle-state-machine') && index.includes('chatui.bundle.js?v=1.3.112-task-lifecycle-state-machine'), 'cache versions should be bumped for regenerate early-refresh recovery');
}
...
function testReasoningCompletesBeforeAnswerStreaming() {
  ...
  const index = fs.readFileSync(path.join(__dirname, '../../index.html'), 'utf8');
  assert.ok(index.includes('chat-workflow.js?v=1.3.24-task-lifecycle-state-machine') && index.includes('chatui.bundle.js?v=1.3.112-task-lifecycle-state-machine'), 'chat stream reasoning-state fix should bump cache versions');
}
...
function testReasoningUnavailableWhenAnswerStartsWithoutReasoning() {
  ...
  const index = fs.readFileSync(path.join(__dirname, '../../index.html'), 'utf8');
  assert.ok(index.includes('chat-workflow.js?v=1.3.24-task-lifecycle-state-machine') && index.includes('chatui.bundle.js?v=1.3.112-task-lifecycle-state-machine'), 'empty-reasoning stream fix should bump cache versions');
}
...
function testReasoningMenuCloseReleasesFocusBeforeAriaHidden() {
  ...
  assert.ok(index.includes('reasoning-workflow.js?v=1.3.35-reasoning-persistence') && index.includes('composer.css?v=1.3.2-gpt5-reasoning-menu') && index.includes('chatui.bundle.js?v=1.3.112-task-lifecycle-state-machine'), 'reasoning menu changes should bump cache versions');
}
...
function testCodeActionHoverAndHistoryAnchorActivePolish() {
  ...
  const index = fs.readFileSync(path.join(__dirname, '../../index.html'), 'utf8');
  assert.ok(index.includes('styles/flat-theme.css?v=2.1.87-route-fit') && index.includes('assets/chatui.bundle.css?v=1.3.112-task-lifecycle-state-machine'), 'CSS bundle cache versions should be bumped for visual fixes');
}
...
function testConfigCopyButtonsForBaseUrlAndApiKey() {
  ...
  assert.ok(index.includes('config-workflow.js?v=1.2.73-configurable-upstream') && index.includes('bootstrap-workflow.js?v=2.0.2-gpt5-reasoning') && index.includes('styles/flat-theme.css?v=2.1.87-route-fit') && index.includes('app.js?v=2.1.25-task-lifecycle-state-machine') && index.includes('chatui.bundle.js?v=1.3.112-task-lifecycle-state-machine'), 'config copy UI changes should bump browser cache versions');
  assert.ok(bundleSource.includes("BUNDLE_VERSION = '1.3.112-task-lifecycle-state-machine'"), 'server bundle version should match config copy cache-busting');
}
...
function testForceImageButtonOnUserMessages() {
  ...
  assert.ok(index.includes('message-workflow.js?v=1.3.36-task-lifecycle-state-machine') && index.includes('app.js?v=2.1.25-task-lifecycle-state-machine') && index.includes('assets/chatui.bundle.css?v=1.3.112-task-lifecycle-state-machine') && index.includes('chatui.bundle.js?v=1.3.112-task-lifecycle-state-machine') && index.includes('styles/flat-theme.css?v=2.1.87-route-fit'), 'force-image UI and action changes should bump cache-busting versions');
  assert.ok(bundleSource.includes("BUNDLE_VERSION = '1.3.112-task-lifecycle-state-machine'"), 'server bundle version should match the force-image bundle cache-busting version');
}
...
function testImagePreviewWheelZoom() {
  ...
  assert.ok(index.includes('image-preview-workflow.js?v=1.2.67') && index.includes('chatui.bundle.js?v=1.3.112-task-lifecycle-state-machine') && index.includes('styles/flat-theme.css?v=2.1.87-route-fit'), 'image preview zoom should bump cache-busting versions');
  assert.ok(bundleSource.includes("BUNDLE_VERSION = '1.3.112-task-lifecycle-state-machine'"), 'server bundle version should match image preview zoom bundle cache-busting');
}
...
function testMessageActionButtonsUsePolishedStyle() {
  ...
  assert.ok(index.includes('assets/chatui.bundle.css?v=1.3.112-task-lifecycle-state-machine') && index.includes('chatui.bundle.js?v=1.3.112-task-lifecycle-state-machine') && index.includes('styles/flat-theme.css?v=2.1.87-route-fit'), 'message action visual polish should bump cache-busting versions');
  assert.ok(bundleSource.includes("BUNDLE_VERSION = '1.3.112-task-lifecycle-state-machine'"), 'server bundle version should match message action polish cache-busting');
}
...
function testPendingFeedbackDoesNotWrapOnMobile() {
  ...
  assert.ok(index.includes('assets/chatui.bundle.css?v=1.3.112-task-lifecycle-state-machine') && index.includes('chatui.bundle.js?v=1.3.112-task-lifecycle-state-machine') && index.includes('styles/flat-theme.css?v=2.1.87-route-fit'), 'pending feedback mobile nowrap fix should bump cache-busting versions');
  assert.ok(bundleSource.includes("BUNDLE_VERSION = '1.3.112-task-lifecycle-state-machine'"), 'server bundle version should match pending feedback cache-busting');
}
...
function testComposerWidthFollowsSidebarCollapsedMessageColumn() {
  ...
  assert.ok(index.includes('assets/chatui.bundle.css?v=1.3.112-task-lifecycle-state-machine') && index.includes('chatui.bundle.js?v=1.3.112-task-lifecycle-state-machine') && index.includes('styles/flat-theme.css?v=2.1.87-route-fit'), 'sidebar composer width fix should bump browser cache versions');
  assert.ok(bundleSource.includes("BUNDLE_VERSION = '1.3.112-task-lifecycle-state-machine'"), 'server bundle version should match sidebar composer cache-busting');
}
...
function testRouteTimeoutShowsSlowNoticeThenFailsCleanly() {
  ...
  assert.ok(index.includes('submit-workflow.js?v=1.2.79-task-lifecycle-state-machine') && index.includes('chat-workflow.js?v=1.3.24-task-lifecycle-state-machine') && index.includes('route-decision-workflow.js?v=1.3.19-single-task-contract') && index.includes('app.js?v=2.1.25-task-lifecycle-state-machine') && index.includes('flat-theme.css?v=2.1.87-route-fit'), 'cache versions should be bumped for route timeout UX');
}
...
function testImageSuccessResultReconciliation() {
  ...
  assert.ok(index.includes('image-result-reconciliation.js?v=1.0.0') && index.indexOf('image-result-reconciliation.js?v=1.0.0') < index.indexOf('app.js?v=2.1.25-task-lifecycle-state-machine'), 'reconciliation module should load before app.js');
  assert.ok(index.includes('image-workflow.js?v=1.3.19-task-lifecycle-state-machine') && index.includes('job-resume-workflow.js?v=1.2.73-task-lifecycle-state-machine') && index.includes('app.js?v=2.1.25-task-lifecycle-state-machine'), 'image success reconciliation should bump workflow and app cache versions');
}
