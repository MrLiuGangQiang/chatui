    ...
    async function onSubmit(e) {
      with (deps) {
          ...
          try{
            ...
            else if(!pendingResolvedRoute&&!(pendingMerge?.merged&&["image","edit_image","chat"].includes(pendingMerge.finalTaskMode)))try{routeInfo=await getEffectiveRouteWithSlowNotice(effectivePromptText,requestAttachments,buildRequestHeaders("message",sessionId),null),routeMode=routeInfo.mode}catch(e){throw e}
