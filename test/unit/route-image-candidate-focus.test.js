...
function testRoutePromptStaysWithinBoundedLength() {
  ...
  assert.ok(routeNodeLength <= 7600, 'route node prompt must remain bounded, got ' + routeNodeLength);
  assert.ok(understandLength <= 2900, 'understand node prompt must remain bounded, got ' + understandLength);
}
