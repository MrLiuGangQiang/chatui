...
function testAllTaskCompletionPathsUseSharedLifecycleFinalizer() {
  ...
  assert.ok(index.indexOf('task-lifecycle.js?v=1.2.5-interface-completion-projection') < index.indexOf('submit-workflow.js?v=1.5.8-canonical-edit-pending-position'),
