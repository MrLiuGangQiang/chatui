...
function testDownloadFilenamesUseShanghaiTimestamp() {
  ...
  assert.ok(index.includes('client/ui/file-actions.js?v=1.2.67') && index.includes('client/app/image-actions-workflow.js?v=1.2.68') && index.includes('client/app/image-result-workflow.js?v=1.2.69') && index.includes('app.js?v=1.3.56-stopfix6') && index.includes('chatui.bundle.js?v=1.3.48-arch86'), 'download filename changes should bump browser cache versions');
  assert.ok(bundleSource.includes("BUNDLE_VERSION = '1.3.48-arch86'"), 'server bundle version should match download filename cache-busting');
}
...
function testChatAnswerStreamingFlushesQuickly() {
  ...
  assert.ok(index.includes('chat-workflow.js?v=1.3.17') && index.includes('chatui.bundle.js?v=1.3.48-arch86') && bundle.includes("BUNDLE_VERSION = '1.3.48-arch86'"), 'cache-busting versions should be bumped for streaming performance fixes');
}
...
function testStreamingTailRendersLightweightCursor() {
  ...
  assert.ok(index.includes('browser-streaming-renderer.js?v=1.2.89') && index.includes('message-workflow.js?v=1.3.31-scrollfix') && index.includes('flat-theme.css?v=2.1.62'), 'cache-busting versions should be bumped for streaming cursor fixes');
}
...
function testQuotePreviewIsFeatureModule() {
  ...
  assert.ok(index.includes('message-workflow.js?v=1.3.31-scrollfix') && index.includes('message-model.js?v=1.0.1') && index.includes('message-domain.js?v=1.0.1') && index.includes('styles/messages.css?v=1.3.12') && index.includes('chatui.bundle.js?v=1.3.48-arch86'), 'quote filtering and jump flash changes should bump cache versions');
...
function testHistoryAnchorLastQuestionSpacerClearsOnSubmit() {
  ...
  assert.ok(index.includes('history-anchor-nav.js?v=1.0.18') && index.includes('submit-workflow.js?v=1.3.62') && index.includes('chatui.bundle.js?v=1.3.48-arch86'), 'history spacer submit fix should bump browser cache versions');
  assert.ok(bundleSource.includes("BUNDLE_VERSION = '1.3.48-arch86'"), 'server bundle version should match the directory spacer fix cache-busting');
}
...
function testReasoningCompletesBeforeAnswerStreaming() {
  ...
  const index = fs.readFileSync(path.join(__dirname, '../index.html'), 'utf8');
  assert.ok(index.includes('chat-workflow.js?v=1.3.17') && index.includes('chatui.bundle.js?v=1.3.48-arch86'), 'chat stream reasoning-state fix should bump cache versions');
}
...
function testReasoningUnavailableWhenAnswerStartsWithoutReasoning() {
  ...
  const index = fs.readFileSync(path.join(__dirname, '../index.html'), 'utf8');
  assert.ok(index.includes('chat-workflow.js?v=1.3.17') && index.includes('chatui.bundle.js?v=1.3.48-arch86'), 'empty-reasoning stream fix should bump cache versions');
}
...
function testReasoningMenuCloseReleasesFocusBeforeAriaHidden() {
  ...
  const index = fs.readFileSync(path.join(__dirname, '../index.html'), 'utf8');
  assert.ok(index.includes('reasoning-workflow.js?v=1.3.29-ds3') && index.includes('chatui.bundle.js?v=1.3.48-arch86'), 'reasoning menu accessibility fix should bump cache versions');
}
...
function testCodeActionHoverAndHistoryAnchorActivePolish() {
  ...
  const index = fs.readFileSync(path.join(__dirname, '../index.html'), 'utf8');
  assert.ok(index.includes('styles/flat-theme.css?v=2.1.62') && index.includes('assets/chatui.bundle.css?v=1.3.48-arch86'), 'CSS bundle cache versions should be bumped for visual fixes');
}
...
function testConfigBaseUrlDefault() {
  ...
  assert.ok(index.includes('config-workflow.js?v=1.2.71') && index.includes('chatui.bundle.js?v=1.3.48-arch86'), 'config default change should bump cache-busting versions');
  assert.ok(bundleSource.includes("BUNDLE_VERSION = '1.3.48-arch86'"), 'server bundle version should match the index cache-busting version');
}
...
function testConfigCopyButtonsForBaseUrlAndApiKey() {
  ...
  assert.ok(index.includes('config-workflow.js?v=1.2.71') && index.includes('bootstrap-workflow.js?v=1.2.84') && index.includes('styles/flat-theme.css?v=2.1.62') && index.includes('app.js?v=1.3.56-stopfix6') && index.includes('chatui.bundle.js?v=1.3.48-arch86'), 'config copy UI changes should bump browser cache versions');
  assert.ok(bundleSource.includes("BUNDLE_VERSION = '1.3.48-arch86'"), 'server bundle version should match config copy cache-busting');
}
...
function testForceImageButtonOnUserMessages() {
  ...
  assert.ok(index.includes('message-workflow.js?v=1.3.31-scrollfix') && index.includes('app.js?v=1.3.56-stopfix6') && index.includes('assets/chatui.bundle.css?v=1.3.48-arch86') && index.includes('chatui.bundle.js?v=1.3.48-arch86') && index.includes('styles/flat-theme.css?v=2.1.62'), 'force-image UI and action changes should bump cache-busting versions');
  assert.ok(bundleSource.includes("BUNDLE_VERSION = '1.3.48-arch86'"), 'server bundle version should match the force-image bundle cache-busting version');
}
...
function testImagePreviewWheelZoom() {
  ...
  assert.ok(index.includes('image-preview-workflow.js?v=1.2.66') && index.includes('chatui.bundle.js?v=1.3.48-arch86') && index.includes('styles/flat-theme.css?v=2.1.62'), 'image preview zoom should bump cache-busting versions');
  assert.ok(bundleSource.includes("BUNDLE_VERSION = '1.3.48-arch86'"), 'server bundle version should match image preview zoom bundle cache-busting');
}
...
function testMessageActionButtonsUsePolishedStyle() {
  ...
  assert.ok(index.includes('assets/chatui.bundle.css?v=1.3.48-arch86') && index.includes('chatui.bundle.js?v=1.3.48-arch86') && index.includes('styles/flat-theme.css?v=2.1.62'), 'message action visual polish should bump cache-busting versions');
  assert.ok(bundleSource.includes("BUNDLE_VERSION = '1.3.48-arch86'"), 'server bundle version should match message action polish cache-busting');
}
...
function testPendingFeedbackDoesNotWrapOnMobile() {
  ...
  assert.ok(index.includes('assets/chatui.bundle.css?v=1.3.48-arch86') && index.includes('chatui.bundle.js?v=1.3.48-arch86') && index.includes('styles/flat-theme.css?v=2.1.62'), 'pending feedback mobile nowrap fix should bump cache-busting versions');
  assert.ok(bundleSource.includes("BUNDLE_VERSION = '1.3.48-arch86'"), 'server bundle version should match pending feedback cache-busting');
}
...
function testRouteTimeoutShowsSlowNoticeThenManualChoice() {
  ...
  assert.ok(index.includes('submit-workflow.js?v=1.3.62') && index.includes('chat-workflow.js?v=1.3.17') && index.includes('route-decision-workflow.js?v=1.3.18') && index.includes('app.js?v=1.3.56-stopfix6') && index.includes('flat-theme.css?v=2.1.62'), 'cache versions should be bumped for route timeout UX');
}
