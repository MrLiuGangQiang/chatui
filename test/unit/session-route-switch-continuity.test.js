...
function testSessionSwitchRecoveryRebindsWithoutDuplicateExecution() {
  ...
  assert.ok(index.includes('runs.js?v=1.2.66-session-run-owner') && index.includes('submit-workflow.js?v=1.2.90-interface-completion') && index.includes('app.js?v=2.1.48-route-model-switch-guard') && index.includes('chatui.bundle.js?v=1.3.147-interface-completion'), 'browser cache versions must deliver the session-run ownership fix');
}
