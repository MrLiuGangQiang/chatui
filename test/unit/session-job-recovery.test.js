...
function testBackgroundSessionsResumeAndShowBusyStateAfterRestore() {
  ...
  assert.ok(index.includes('bootstrap-workflow.js?v=2.0.2-gpt5-reasoning') && index.includes('app.js?v=2.1.8-job-recovery'), 'runtime entry assets should receive cache-version updates with the recovery fix');
}
