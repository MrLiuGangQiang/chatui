...
function testUsageStatsScriptsLoadInExpectedOrder() {
  ...
  assert.ok(css.includes('.usage-stats-button,.announcement-toolbar-button{border-color:#bfdbfe!important;background:#eff6ff!important;color:#1d4ed8!important') && css.includes('.usage-stats-button:hover,.announcement-toolbar-button:hover{background:#dbeafe!important'), 'the usage and announcement launchers should share the same light-blue entry surface');
