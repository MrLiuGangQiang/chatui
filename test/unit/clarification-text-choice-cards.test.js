...
function testTextChoiceListUsesSimpleAlignedRows() {
  ...
  assert.match(css, /\.clarification-presentation\[data-clarification-choice-options="1"\] \.clarification-choice-list \.clarification-choice-number\{[\s\S]*?border-radius:6px;[\s\S]*?background:var\(--msg-accent-soft, #eff6ff\);/,
