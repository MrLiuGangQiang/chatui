...
function testBackgroundSessionsResumeAndShowBusyStateAfterRestore() {
  ...
  assert.ok(index.includes('bootstrap-workflow.js?v=2.1.0-preinsert-guard') && index.includes('app.js?v=2.1.37-preinsert-guard'), 'runtime entry assets should receive cache-version updates with the recovery fix');
}
